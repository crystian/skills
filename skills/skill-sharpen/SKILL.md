...
Observe how a skill performed, find what went wrong or could be better, and propose concrete
changes to its SKILL.md. Feed from conversation history, file diffs, and explicit user feedback.
